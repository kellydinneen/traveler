...
export let tripData = [
    ...
    {"id":2,"userID":1,"destinationID":2,"travelers":5,"date":"2021/01/16","duration":18,"status":"approved","suggestedActivities":[]},
    {"id":3,"userID":2,"destinationID":3,"travelers":4,"date":"2021/05/22","duration":17,"status":"pending","suggestedActivities":[]}
  ];

export default {travelerData, destinationData, tripData};
